...
class MainTest {
    ...
    void triangle_category() {
        PointTriangle a = new PointTriangle(new Point(0, 0), new Point(6, 0), new Point(3, 3 * Math.sqrt(3)));
        PointTriangle b = new PointTriangle(new Point(0, 0), new Point(6, 0), new Point(3, 0));
        PointTriangle c = new PointTriangle(new Point(0, -3), new Point(0, 0), new Point(-4, 0));
    ...
    @Test
    void triangle_area() {
        PointTriangle a = new PointTriangle(new Point(0, 0), new Point(2, 0), new Point(0, 2));
        PointTriangle b = new PointTriangle(new Point(0, 0), new Point(0, 0), new Point(0, 0));
        PointTriangle c = new PointTriangle(new Point(0, -3), new Point(0, 0), new Point(-4, 0));
